  ...
  return (
    <div className='lg:hidden flex flex-col items-center justify-center'>
      ...
      <div className='flex flex-row items-center justify-center mb-3'>
        ...
        <button className='text-white md:p-2 bg-pink-600 md:rounded-md'><DinnerDiningIcon style={{fontSize:"40"}} className='p-2' onClick={()=>navigate('/chatbot')}/>CHat Bot</button>
      </div>
